...
const routes = [{
    ...
    },
    {
        ...
        children: [{
                ...
                name: 'WriteBlog',
                component: () =>
                    import ('@/views/blog/blog/WriteBlog'),
            ...
            },
            {
                ...
                name: 'WriteMoment',
                component: () =>
                    import ('@/views/blog/moment/WriteMoment'),
            ...
            },
            {
                ...
                name: 'BlogList',
                component: () =>
                    import ('@/views/blog/blog/BlogList'),
            ...
            },
            {
                ...
                name: 'MomentList',
                component: () =>
                    import ('@/views/blog/moment/MomentList'),
            ...
            },
            {
                ...
                name: 'CategoryList',
                component: () =>
                    import ('@/views/blog/category/CategoryList'),
            ...
            },
            {
                ...
                name: 'CommentList',
                component: () =>
                    import ('@/views/blog/comment/CommentList'),
    ...
    },
    {
        ...
        children: [{
                ...
                name: 'Setting',
                component: () =>
                    import ('@/views/pictureHosting/Setting'),
            ...
            },
            {
                ...
                name: 'GithubManage',
                component: () =>
                    import ('@/views/pictureHosting/GithubManage'),
            ...
            },
            {
                ...
                name: 'UpyunManage',
                component: () =>
                    import ('@/views/pictureHosting/UpyunManage'),
            ...
            },
            {
                ...
                name: 'TxyunManage',
                component: () =>
                    import ('@/views/pictureHosting/TxyunManage'),
    ...
    },
    {
        ...
        children: [{
            ...
            },
            {
                ...
                name: 'JobList',
                component: () =>
                    import ('@/views/system/ScheduleJobList'),
    ...
    },
    {
        ...
        children: [{
                ...
                name: 'JobLog',
                component: () =>
                    import ('@/views/log/ScheduleJobLog'),
    ...
    },
    {
        ...
        children: [{
            ...
            name: 'Visitor',
            component: () =>
                import ('@/views/statistics/Visitor'),
